export const siteContent = {
  ...
  footer: {
    ...
    connect: {
      ...
      description:
        "Follow us on social media for wellness tips, updates, and inspiration.",
      socialLinks: [
        {
          platform: "Facebook",
  ...
  faq: {
    ...
    questions: [
      ...
      {
        question:
          "What if I'm already on some form of HRT, like creams, patches, or pills?",
        answer:
          "Transitioning to pellet therapy from other forms of HRT is common. Your physician can assess your needs even if you're currently using another type of hormone replacement therapy. If you prefer to continue with your current HRT but are not ready for pellets, we can offer alternative formulations.",
      },
      {
  ...
  nutraceuticals: {
    ...
    description:
      "Premium quality supplements designed to support your wellness journey. Our comprehensive range of nutraceuticals is carefully selected to provide optimal nutritional support, enhance your body's natural functions, and promote overall well-being.",
    products: [
      {
        name: "QuiCalm",
        description:
    ...
    servicesList: [
      {
        ...
        description:
          "Personalized hormone replacement therapy using bioidentical hormones to restore balance and vitality. Our comprehensive approach includes detailed testing and ongoing monitoring to ensure optimal results.",
      ...
      },
      {
        ...
        title: "Thyroid",
        description:
          "A dietary supplement to support thyroid function and health. This is a vegetarian blend of Tyrosine with herbal extracts, vitamins and minerals, not found in other supplements, and includes patented ForsLean Coleius forkskohlii to support the maintenance and proper function of a healthy thyroid.",
      ...
      },
      {
        ...
        title: "PCOS",
        description:
          "Specialized care for Polycystic Ovary Syndrome through an integrative approach. We combine lifestyle modifications, hormone balancing, and targeted supplementation to manage PCOS effectively.",
      ...
      },
      {
        ...
        description:
          "Comprehensive weight management programs that focus on sustainable results. Our approach combines medical supervision, nutritional guidance, and lifestyle optimization.",
      ...
      },
      {
        ...
        title: "IV Therapy",
        description:
          "Advanced IV therapy treatments for optimal nutrient delivery and health support.",
        image: "https://images.unsplash.com/photo-1631815589654-b2a4d6fa7ee3",
        comingSoon: false,
        availableDate: "March 2025",
  ...
  home: {
    hero: {
      title: "Divine Design Wellness",
      description:
        "Divine Design Wellness is located in Decatur TX, and is part of the Empowered Life collective.",
    ...
    about: {
      title: "About Us",
      description:
        "Divine Design Wellness is committed to overall wellness, health & a traditional, natural approach to healthcare.",
    ...
    hormoneTherapy: {
      ...
      description:
        "Experience the transformative power of EvexiPEL, our flagship bioidentical hormone therapy. Using plant-based pellets derived from yams, we deliver sustained, steady hormone optimization tailored to your unique needs.",
      highlights: [
    ...
    team: {
      title: "Our Team",
      subtitle:
        "Meet our experienced professionals dedicated to your wellness journey.",
      teamMembers: [
        {
          name: "Kelly",
          role: "Nurse Practitioner",
          image: "/assets/kelly-hero.JPEG",
        },
      ],
      ...
      featuredQuestions: [
        {
          question: "What if I've had breast cancer?",
          answer:
            "Our approach to hormone therapy for breast cancer survivors is highly personalized and carefully considered. We conduct comprehensive evaluations and work closely with your oncology team to develop a safe, effective treatment plan.",
      ...
      featured: [
        {
          title: "Bioidentical HRT",
          description:
            "Personalized hormone replacement therapy using bioidentical hormones to restore balance and vitality.",
          link: "/services#bhrt",
        },
        {
          title: "Thyroid",
        ...
        },
        {
          title: "PCOS",
          description:
            "Specialized care for Polycystic Ovary Syndrome through an integrative approach.",
          link: "/services#pcos",
        },
        {
          title: "Weight Loss and Management",
          description:
            "Comprehensive weight management programs that focus on sustainable results.",
    ...
    nutraceuticals: {
      ...
      subtitle:
        "Premium supplements and wellness products to support your health journey",
      featured: [
        {
          title: "QuiCalm",
          description:
  ...
  contact: {
    hero: {
      title: "Contact Us",
      subtitle:
        "We're here to help you on your wellness journey. Reach out to us with any questions or to schedule an appointment.",
    },
    info: {
      location: {
        title: "Location",
